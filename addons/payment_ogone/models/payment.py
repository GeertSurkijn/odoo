...
class PaymentAcquirerOgone(models.Model):
    ...
    ogone_shakey_in = fields.Char('SHA Key IN', size=36, required_if_provider='ogone', groups='base.group_user')
    ogone_shakey_out = fields.Char('SHA Key OUT', size=36, required_if_provider='ogone', groups='base.group_user')
